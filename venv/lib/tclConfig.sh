...
# installed.
TCL_PREFIX='/Users/adnanbasar/Adnan's Github Repos/whatisio/venv'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/Users/adnanbasar/Adnan's Github Repos/whatisio/venv'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/Users/adnanbasar/Adnan's Github Repos/whatisio/venv/lib -ltcl8.5'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/Users/adnanbasar/Adnan's Github Repos/whatisio/venv/include'
...
TCL_PACKAGE_PATH='/Users/adnanbasar/Adnan's Github Repos/whatisio/venv/lib '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/Users/adnanbasar/Adnan's Github Repos/whatisio/venv/lib -ltclstub8.5'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='-------src-dir--------/tcl8.5.13/unix/libtclstub8.5.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/Users/adnanbasar/Adnan's Github Repos/whatisio/venv/lib/libtclstub8.5.a'
